...
public class ExcelHelperAsitRevTelephony {
	static Logger logger = LogManager.getLogger(ExcelHelperAsitRevTelephony.class);

	static String[] HEADERs = {"Month", "FUSION_ID", "ADHERENCE_PERCENTAGE","IB_AHT"};
	
	  static String SHEET = "Sheet1";
	  
	  public static List<ASIT_REV_TELEPHONY> excelToObjects(InputStream is)
	  {
		  ...
		  try {
		      ...
		      List<ASIT_REV_TELEPHONY> objects = new ArrayList<ASIT_REV_TELEPHONY>();
		      ...
		      while (rows.hasNext()) {
		        ...
		        ASIT_REV_TELEPHONY object = new ASIT_REV_TELEPHONY();
