...
public class ExcelHelperAsitRevCmsDefect {
	static Logger logger = LogManager.getLogger(ExcelHelperAsitRevCmsDefect.class);
	
	static String[] HEADERs = { "Month", "FUSIONID", "NAME", "TEAM_LEADER","DEPT" };
	  static String SHEET = "Sheet1";
	  
	  public static List<ASIT_REV_CMS_DEFECT> excelToObjects(InputStream is)
	  {
		  ...
		  try {
		      ...
		      List<ASIT_REV_CMS_DEFECT> objects = new ArrayList<ASIT_REV_CMS_DEFECT>();
		      ...
		      while (rows.hasNext()) {
		        ...
		        ASIT_REV_CMS_DEFECT object = new ASIT_REV_CMS_DEFECT();
		        ...
		        while (cellsInRow.hasNext()) {
		          ...
		          case 5:
		        	  if(formatter.formatCellValue(currentCell).length()==0
	        		  || formatter.formatCellValue(currentCell).equals(""))
		        		  object.setTotalMonitors(0);
		        	  else
		        	  {
		        		  //System.out.println("Setting defect %");
		        		  object.setTotalMonitors(currentCell.getNumericCellValue());
		          ...
		          case 6:
		        	  ...
		        	  {
		        		  //System.out.println("Setting defect %");
		        		  object.setDefects(currentCell.getNumericCellValue());
		        		  //System.out.println("Defect % = " + currentCell.getNumericCellValue());
		        	  }
		            break;
