...
@Entity
@Table(name = "ASIT_TL_QC")
public class ASIT_TL_QC {

	@Id
	@Column(name = "ID")
	  @GeneratedValue(strategy=GenerationType.AUTO, generator="tlqcid_generator")
	  @SequenceGenerator(name="tlqcid_generator", sequenceName = "ASIT_TL_QC_SEQ", allocationSize=1)
	  private long id;
