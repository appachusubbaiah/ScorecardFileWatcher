...
public class ExcelHelperAsitTLQC {
static Logger logger = LogManager.getLogger(ExcelHelperAsitTLQC.class);
	
	static String[] HEADERs = { "Month", "FUSIONID", "UCID" ,"NAME", "ASST_MNGR_NAME","MNGR_NAME","LOCATION", "DEPT", "Opportunities", "Defect" };
	static String SHEET = "Sheet1";
	
	public static List<ASIT_TL_QC> excelToObjects(InputStream is){
		...
		SimpleDateFormat sdf=null;
		  ...
		  try {
		      ...
		      List<ASIT_TL_QC> objects = new ArrayList<ASIT_TL_QC>();
		      ...
		      while (rows.hasNext()) {
		        ...
		        ASIT_TL_QC object = new ASIT_TL_QC();
